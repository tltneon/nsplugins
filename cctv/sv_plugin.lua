...
function PLUGIN:LoadData()
	for k, v in pairs(nut.util.ReadTable("cctv_cameras")) do
	...
	for k, v in pairs(nut.util.ReadTable("cctv")) do
		local position = v.pos
		local angles = v.angles
...
function PLUGIN:SaveData()
	...
	nut.util.WriteTable("cctv_cameras", data)
	local data = {}
	for k, v in pairs(ents.FindByClass("nut_cctv")) do
		data[#data + 1] = {
			pos = v:GetPos(),
