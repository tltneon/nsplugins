...
SWEP.VElements = {
	["weapon"] = { type = "Model", model = "models/warz/melee/baseballbat_spike.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(-0.5, 0, 16.908), angle = Angle(1, 93.068, -3), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["weapon"] = { type = "Model", model = "models/warz/melee/baseballbat_spike.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.181, 1, -16.909), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:Impact( trcTrace )
	...
	self.Owner:EmitSound( Format( "physics/wood/wood_crate_impact_hard%d.wav", math.random(1,3 ) ), 80, math.random( 100, 120 ), .5 )
end