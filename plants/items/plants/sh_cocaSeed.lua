ITEM.name = "Coca Seeds"
ITEM.uniqueID = "cocaSeed"
ITEM.model = Model("models/props_lab/box01a.mdl")
ITEM.desc = "Produces Coca Leaves once grown and gathered."
ITEM.plant = "cocaLeave"
ITEM.plantmdl = "models/props/de_inferno/largebush01.mdl"
ITEM.time = 550
ITEM.pos = Vector(1, -1, 12)
