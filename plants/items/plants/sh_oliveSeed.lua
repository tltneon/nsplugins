ITEM.name = "Olive Seeds"
ITEM.uniqueID = "oliveSeed"
ITEM.model = Model("models/props_lab/box01a.mdl")
ITEM.desc = "Produces Fresh Olives once grown and gathered."
ITEM.plant = "freshOlive"
ITEM.plantmdl = "models/props/de_inferno/potted_plant1_p1.mdl"
ITEM.time = 300
ITEM.pos = Vector(-1, 0, -1)
ITEM.ang = Angle(0, -90, 0)
ITEM.price = 10
ITEM.functions = {}
